        ...
        <div className='my-8 w-full max-w-md mx-auto bg-white rounded-2xl shadow-md overflow-hidden'>
            <div className='flex items-center justify-between p-4 border-b border-gray-100'>
                <div className='flex items-center gap-3'>
                    <Avatar className="w-10 h-10">
                        ...
                        <AvatarFallback className="bg-green-200">CN</AvatarFallback>
                    </Avatar>
                    <div className='flex flex-col'>
                        <h1 className="font-semibold text-gray-800">{post.author?.username}</h1>
                        {user?._id === post.author._id && <Badge variant="secondary" className="text-xs text-green-700 bg-green-50 px-2 py-0.5 leading-tight h-fit w-fit">
                        Author
                        </Badge>}
                    </div>
                </div>
            ...
            <div className='p-4'>
                    ...
                    <div className='flex items-center gap-4'>
                        <Button variant="ghost" size="icon" onClick={likeOrDislikeHandler}>
                            {liked 
                                ...
                                : <FaRegHeart size={24} className='text-grey-600 hover:text-green-600' />
                            }
                        </Button>
                        <Button variant="ghost" size="icon" onClick={() => {
                            ...
                            <MessageCircle className='text-grey-600 hover:text-green-600' />
                        </Button>
                        <Button variant="ghost" size="icon">
                            <Send className='text-grey-600 hover:text-green-600' />
                        </Button>
                    </div>
                    <Button variant="ghost" size="icon" onClick={bookmarkHandler}>
                        <Bookmark className='text-grey-600 hover:text-green-600' />
                    </Button>
                </div>
                ...
                {comment.length > 0 && (
                    <Button 
                        variant="link" 
                        className="p-0 h-auto text-sm text-gray-500 hover:text-green-600"
                        onClick={() => {
                            dispatch(setSelectedPost(post));
                            setOpen(true);
                        }}
