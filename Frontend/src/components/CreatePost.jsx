  ...
  return (
    <Dialog open={open}>
      <DialogContent onInteractOutside={() => setOpen(false)} className="bg-white rounded-2xl shadow-lg max-w-md w-full mx-auto">
        <DialogHeader className='text-center font-bold text-xl text-green-800 mb-4'>Create New Post</DialogHeader>
        ...
        <Textarea 
          ...
          className="focus-visible:ring-green-300 border-gray-200 rounded-lg mb-4" 
